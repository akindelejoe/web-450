...
import { AgentPerformanceByFeedbackComponent } from './reports/agent-performance/agent-performance-by-feedback/agent-performance-by-feedback.component';
...
import { SalesComponent } from './reports/sales/sales-by-region-tabular/sales.component';
...
export const salesReportRoutes: Routes = [
  { path: 'sales-by-region', component: SalesByRegionComponent },
  { path: 'sales-by-region-tabular', component: SalesByRegionTabularComponent },
];

export const agentPerformanceRoutes: Routes = [
  { path: 'call-duration-by-date-range', component: CallDurationByDateRangeComponent },
  { path: 'agent-performance-by-feedback', component: AgentPerformanceByFeedbackComponent },
];
